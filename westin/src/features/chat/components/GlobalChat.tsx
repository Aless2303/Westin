...
const GlobalChat: React.FC = () => {
  ...
  // Obține ID-ul caracterului
  // În mod normal ar trebui transmis ca props, dar pentru demo folosim "character"
  ...
  // Derulează în jos la fiecare mesaj nou
  useEffect(() => {
    scrollToBottom();
  }, [globalMessages]);
  ...
  const shouldShowHeader = (index: number) => {
    ...
    const currentMessage = globalMessages[index];
    const previousMessage = globalMessages[index - 1];
      ...
      <form onSubmit={handleSendMessage} className="mt-auto">
        <div className="flex items-center bg-metin-dark/80 border border-metin-gold/30 rounded-md overflow-hidden">
          <input
            ...
            placeholder="Scrie un mesaj în canalul global..."
